        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="bg-yellow-300 text-black rounded-lg flex items-center gap-2 px-5 py-2.5 font-semibold text-sm hover:opacity-90 transition-opacity"
            >
      ...
      {isMobileOpen && (
        <div className="fixed inset-0 z-40 bg-background/98 backdrop-blur-xl md:hidden">
          <div className="flex flex-col items-center justify-center h-full gap-6">
            ...
            <a
              href="tel:+447000000000"
              className="flex items-center gap-2 bg-yellow-300 text-black px-8 py-3 rounded-lg font-semibold text-lg mt-4"
            >
